...
async def start(client,message):
	...
	**Document Or Video** and enter new filename to rename it__
	...
	reply_markup=InlineKeyboardMarkup(
	 [[ InlineKeyboardButton("Support 🇮🇳" ,url="https://t.me/honey_networks") ], 
	[InlineKeyboardButton("Subscribe 🧐", url="https://t.me/honey_networks") ]  ]))
	    return
	if id:
	        if id == procode:
...
async def send_doc(client,message):
       ...
       if user_type=="Free":
           LIMIT = 600
           await message.reply_text(f"Complete The Task and get Free subscription per day @ALLTYPECC")
           return
